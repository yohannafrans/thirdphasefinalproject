...
backend kubernetes-master-nodes
    ...
    balance roundrobin
    option tcp-check
    server master-1 172.20.2.10:6443 check fall 3 rise 2
    server master-2 172.20.2.76:6443 check fall 3 rise 2
    server master-3 172.20.2.102:6443 check fall 3 rise 2    
EOF
